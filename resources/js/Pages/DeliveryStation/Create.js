...
const Create = ({toastId}) => {
    ...
    const handleSubmit = (values) => {
        Inertia.post(route("delivery-station.store", values))
        toastId.current = toast("Adding New Delivery Station...", { autoClose: false })
    }
    ...
    if(usePage().props.flash.success){
        toast.update(toastId.current, {render: "New Delivery Station Is Added", type: toast.TYPE.SUCCESS, autoClose: 5000})
    }
