...
const Create = ({toastId}) => {
    ...
    const handleSubmit = (values) => {
        Inertia.post(route("delivery-partner.store", values))
        toastId.current = toast("Adding New Partner Station...", { autoClose: false })
    }
    ...
    if(usePage().props.flash.success){
        toast.update(toastId.current, {render: "New Delivery Partner Is Added", type: toast.TYPE.SUCCESS, autoClose: 5000})
    }
